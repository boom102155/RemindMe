...
### <ins>8. วิธีจดรายรับ-รายจ่ายจากสลิปโอนเงิน</ins>
1. สร้าง Google Cloud project และเปิดใช้ **Cloud Vision API** พร้อมเชื่อมบัญชี Billing
2. สร้าง API key โดยจำกัดสิทธิ์ให้ใช้ได้กับ Cloud Vision API เท่านั้น
3. ใน Web App ไปที่หน้า **ตั้งค่า → เชื่อมต่อ LINE** แล้วใส่ key ในช่อง **Google Cloud Vision API key (อ่านสลิปโอนเงิน)** จากนั้นกดบันทึก
4. ส่งรูปสลิปโอนเงินให้ LINE Bot ในแชตส่วนตัว ระบบจะอ่านยอดเงิน วันที่ และคู่รายการจากสลิป
5. เลือกขอบเขตค่าใช้จ่ายผ่าน Quick Reply: **ส่วนตัว** หรือ **ที่ทำงาน**
