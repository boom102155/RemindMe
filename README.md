...
- **วิธี A (ทั่วไป):** เปิดลิงก์โปรเจกต์ Apps Script ที่ผู้พัฒนาแชร์ให้ → คลิกเมนู **ภาพรวม (Overview)** ที่แถบเมนูด้านซ้าย → กดปุ่ม **ทำสำเนา (Make a copy)** ที่มุมขวาบนของหน้าภาพรวม
